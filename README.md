...
║                                                              ║
║   _____  _   _ _____ _   __ _   _   ___  _____ _   _ _____   ║
║  /  __ \| | | |_   _| | / /| | | | / _ \|  _  | | | |_   _|  ║
║  | /  \/| |_| | | | | |/ / | |_| |/ /_\ \ | | | | | | | |    ║
║  | |    |  _  | | | |    \ |  _  ||  _  | | | | | | | | |    ║
║  | \__/\| | | |_| |_| |\  \| | | || | | \ \_/ / |_| |_| |_   ║
║   \____/\_| |_/\___/\_| \_/\_| |_/\_| |_/\___/ \___/ \___/   ║
║                                                              ║
...
### 👻 [GhostLayer](https://github.com/akrem-dev-ops/GhostLayer)
> Cyberpunk-Themed Tactical Proxy Enforcer for Windows

- Automated **Tor IP rotation** with one-click circuit refresh
- Strict **exit-node geo-locking** — force traffic through specific countries
- **Real-time throughput monitoring** dashboard
- System-wide proxy enforcement via Windows registry
- Built with Python · stem · requests · Tkinter
...
- Supports **RAR archives** and Microsoft Office documents (`.xlsx`, `.xls`, `.docx`, `.doc`)
- **Parallel multiprocessing** with adaptive core-throttling for maximum speed
- **Pinpoint telemetry** — exact real-time string index displayed as workers run
- **Session checkpointing** — safely interrupt and resume at any point
- Dual-theme **Dark / Light** Tkinter UI with non-blocking task queue
- Built with Python · multiprocessing · rarfile · msoffcrypto-tool · Tkinter
